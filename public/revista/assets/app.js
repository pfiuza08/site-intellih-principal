(function () {
  ...
  // Sem cards pesquisáveis (artigos e editorias vazias), não exibir uma busca inoperante.
  if (!cards.length) {
    searchToggle?.remove();
    panel?.remove();
  }
  ...
  if (cards.length && searchToggle && panel) {
