...
<section class="brand-feature"><div class="wrap feature-grid"><div><span class="eyebrow" style="color:#ff9e5e">ESPECIAL · PARECE INVENTADO?</span><h2>O extraordinário também é real.</h2><p>Por trás de uma pergunta surpreendente, há uma história que merece ser investigada. Descubra o que é fato, hipótese ou exagero.</p><a class="feature-link" href="./editorias/parece-inventado.html">Conheça o especial →</a></div><div class="feature-symbol-wrap"><img class="feature-symbol parece-symbol" src="/revista/assets/img/parece-inventado-icone.png" width="600" height="600" alt="Símbolo do especial Parece Inventado?" loading="lazy"></div></div></section>
